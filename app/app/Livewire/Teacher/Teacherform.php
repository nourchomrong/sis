...
class Teacherform extends Component
{
    ...
    public function submit()
    {
        ...
        // Handle photo
        if ($photoPath && $teacher) {
            if ($teacher->photo) {
                Storage::disk('public')->delete($teacher->photo->photo_path);
                $teacher->photo->update(['photo_path' => $photoPath, 'status' => 'A']);
            } else {
                $teacher->photo()->create(['photo_path' => $photoPath, 'status' => 'A']);
            }
        }
