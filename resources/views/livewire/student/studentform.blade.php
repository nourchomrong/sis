    ...
    @if($showModal)
        ...
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50"
            ...
            <div class="relative top-5 mx-auto p-5 border md:w-1/2 w-96 shadow-lg rounded-md bg-white" wire:click.stop>
                <div class="mt-3 ">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Student Form</h3>
                        ...
                        <div class="grid gap-6 mb-6">
                            <form wire:submit.prevent="submit">
                                ...
                                <div class="flex justify-end space-x-2 mt-4">
                                    <x-form.button type="submit" color="green" wire:loading.attr="disabled" wire:target="photo,submit">
